#!/usr/bin/env python3
"""Perceived-latency benchmark for diff-reckoner.
...
Usage:
  scripts/bench_tui.py --binary target/release/diff-reckoner --fixture
  scripts/bench_tui.py --binary target/release/diff-reckoner --repo /path/to/repo --label landing
