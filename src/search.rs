...
//!
//! The engine owns matching, ranking, and indexing; diff-reckoner passes the query through and
...
pub fn cache_dir() -> PathBuf {
    dirs::cache_dir().unwrap_or_else(std::env::temp_dir).join("diff-reckoner")
}
